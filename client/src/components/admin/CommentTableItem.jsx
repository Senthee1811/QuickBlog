...
const CommentTableItem = ({comment,fetchComments}) => {
  ...
  return (
    <tr className='order-y border-green-300'>
        <td>
        ...
        <td className='px-6 py-4 '>
            <div className='inline-flex items-center gap-4'>
                {!comment.isApproved ? 
                <img src={assets.tick_icon} alt="" className='w-5 hover:scale-110 transition-all cursor-pointer'/> : <p className='text-xs border

...
const AddBlog = () => {
  ...
  return (
    ...
    <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'> 
      ...
      <input type="text" placeholder="Type here" required value={title} className='w-full
      max-w-lg mt-2 p-2 border border-gray-300 outline-none rounded' 
      onChange={(e) => {setTitle(e.target.value)}}/> 

      <p className='mt-4'>Sub Title</p> 
      <input type="text" placeholder="Type here" required value={subTitle} className='w-full
      max-w-lg mt-2 p-2 border border-gray-300 outline-none rounded' 

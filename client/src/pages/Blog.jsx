  ...
  return data ?  (
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        ...
        <h2 className='my-5 maxw-lg truncate mx-auto'>{data.subTitle}</h2> 
        <p className='inline-block py-1 px-4 rounded-full mb-6 border border-primary/35
        text-sm bg-primary/5 font-medium text-primary'>Mitchell Marsh</p>
      ...
      <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
        ...
        <div className='mt-14 mb-10 max-w-3xl mx-auto'> 
          <p className='font-semibold mb-4'>Coments ({comments.length})</p> 
